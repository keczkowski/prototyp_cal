...
class AdditionalServicesTest < ApplicationSystemTestCase
  ...
  test "creating a Additional service" do
    visit additional_services_url
    click_on "New Additional Service"

    fill_in "Body", with: @additional_service.body
  ...
  test "updating a Additional service" do
    visit additional_services_url
  ...
  test "destroying a Additional service" do
    visit additional_services_url
