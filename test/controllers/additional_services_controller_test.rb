...
class AdditionalServicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create additional_service" do
    assert_difference('AdditionalService.count') do
      post additional_services_url, params: { additional_service: { body: @additional_service.body, name: @additional_service.name } }
    end
  ...
  test "should update additional_service" do
    patch additional_service_url(@additional_service), params: { additional_service: { body: @additional_service.body, name: @additional_service.name } }
