...
class ConceptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post concepts_url, params: { concept: { body: @concept.body, name: @concept.name, user_id: @concept.user_id } }
    end
  ...
  test "should update concept" do
    patch concept_url(@concept), params: { concept: { body: @concept.body, name: @concept.name, user_id: @concept.user_id } }
